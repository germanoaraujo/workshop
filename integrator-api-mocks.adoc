...
+
image::mock-17.png[mock-mock-operation, role="integr8ly-img-responsive"]
...
+
image::mock-18.png[mock-curl-service, role="integr8ly-img-responsive"]
...
+
image::mock-19.png[mock-curl-response, role="integr8ly-img-responsive"]
